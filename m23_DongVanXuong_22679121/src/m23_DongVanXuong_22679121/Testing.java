...
public class Testing {
	...
	private static Product createNewProduct() {
		...
		String description = sc.nextLine(); Supplier supplier = createNewSupplier();
		System.out.println("Enter price: ");
		double price = sc.nextDouble();
		return new Product (productID, name, manufacture, description, supplier,
		price);
	}
	...
	private static void createMenu() {
		...
		System.out.println("4. Print all"); System.out.println("5. Write XML file");
